...
import { Package, Zap, Users, ShieldCheck, Award, Thermometer, Settings, BookOpen, Truck, Cpu } from 'lucide-react';
...
export default async function HomePage() {
  const featuredProducts: Product[] = await getProducts({ limit: 3 });
